...
- Run a script: `uv run src/destiny/examples/agv_moving_a_box.py`
- Run tests: `uv run pytest`
- Run a specific test: `uv run pytest tests/test_simulation_container.py`
