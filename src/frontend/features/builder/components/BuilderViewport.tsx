...
import { type VisualizationHooks,VisualizationProvider } from "@features/visualization/hooks/VisualizationContext";
...
export const BuilderViewport = () => {
  ...
  const hooks: VisualizationHooks = useMemo(() => ({
    ...
    useEntity: (containerRef: RefObject<Container | null>, entityId: string | undefined) => {
