    ...
    return (
      ...
      >
        <CardHeader className="text-center">
          <CardTitle className="text-xl">Simulation Viewer</CardTitle>
          <CardDescription>Upload a recording to get started</CardDescription>
        </CardHeader>
        <CardContent>
    ...
    >
      <div className="flex flex-row items-center gap-3 pl-4 pr-1 py-1">
        ...
        <Button
          ...
          className={cn("rounded-full", "active:scale-90")}
